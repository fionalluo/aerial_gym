...
task_registry.register_task("navigation_task_custom", NavigationTaskCustomBase, navigation_task_config)
task_registry.register_task("navigation_task_custom_gym", NavigationTaskCustomEnv, navigation_task_config)
